...
from _reference_pre_project.Project4_object_detect.darknet.dataset import Yolo_dataset
from _reference_pre_project.Project4_object_detect.darknet.cfg import Cfg
from _reference_pre_project.Project4_object_detect.darknet.models import Yolov4
from _reference_pre_project.Project4_object_detect.darknet.tool.darknet2pytorch import Darknet

from _reference_pre_project.Project4_object_detect.darknet.tool.tv_reference.utils import collate_fn as val_collate
from _reference_pre_project.Project4_object_detect.darknet.tool.tv_reference.coco_utils import convert_to_coco_api
from _reference_pre_project.Project4_object_detect.darknet.tool.tv_reference.coco_eval import CocoEvaluator
...
def get_args(**kwargs):
    ...
    parser.add_argument('-train_label_path', dest='train_label',
                        type=str, default='train.txt', help="train label path")
    parser.add_argument(
