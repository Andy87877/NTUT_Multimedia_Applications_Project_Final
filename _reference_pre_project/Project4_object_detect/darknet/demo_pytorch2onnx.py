...
from _reference_pre_project.Project4_object_detect.darknet.tool.utils import *
from _reference_pre_project.Project4_object_detect.darknet.models import Yolov4
from _reference_pre_project.Project4_object_detect.darknet.demo_darknet2onnx import detect
...
def transform_to_onnx(weight_file, batch_size, n_classes, IN_IMAGE_H, IN_IMAGE_W):
    ...
    if dynamic:
        ...
        x = torch.randn((batch_size, 3, IN_IMAGE_H,
                        IN_IMAGE_W), requires_grad=True)
...
def main(weight_file, image_path, batch_size, n_classes, IN_IMAGE_H, IN_IMAGE_W):
    ...
    if batch_size <= 0:
        ...
        transform_to_onnx(weight_file, batch_size,
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 7:
        ...
        main(weight_file, image_path, batch_size,
             n_classes, IN_IMAGE_H, IN_IMAGE_W)
    else:
