...
from _reference_pre_project.Project4_object_detect.darknet.tool.darknet2onnx import *
...
def detect(session, image_src, namesfile):
    ...
    plot_boxes_cv2(
        image_src, boxes[0], savename='predictions_onnx.jpg', class_names=class_names)
